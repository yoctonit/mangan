...
private:
    ...
    Mn::Uniform lightCutOffUniform{};
    Mn::Uniform lightOuterCutOffUniform{};
...
public:
    CoordinateSystems() {
        ...
        lightCutOffUniform.Create(shader.Locate("light.cutOff"), Mn::Uniform::Type::Float);
        lightOuterCutOffUniform.Create(shader.Locate("light.outerCutOff"), Mn::Uniform::Type::Float);
    ...
    void Update(const Mn::Input &input) {
        ...
        lightPositionUniform = camera.Position;
        lightDirectionUniform = camera.Front;
        lightCutOffUniform = glm::cos(glm::radians(12.5f));
        lightOuterCutOffUniform = glm::cos(glm::radians(17.5f));
        lightAmbientUniform = glm::vec3(0.1f, 0.1f, 0.1f);
        ...
        lightDiffuseUniform = glm::vec3(0.8f, 0.8f, 0.8f);
    ...
    void Render() const {
        ...
        lightCutOffUniform.Upload();
        lightOuterCutOffUniform.Upload();
