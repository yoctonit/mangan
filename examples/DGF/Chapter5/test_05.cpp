...
public:
    void initialize(int, int) {
        ...
        noiseTex = std::make_shared<Texture>("images/noise.png");

        material = std::make_shared<Material>("shader/Test_5_3.vert", "shader/Test_5_5.frag");
    ...
    void update(const Mn::Input& input, double delta_time) {
        ...
        material->uniforms["texture2"].upload(noiseTex->textureRef, 2);
